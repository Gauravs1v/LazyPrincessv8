...
BOT_TOKEN = environ.get('BOT_TOKEN', "6959495516:AAFd4W9WWbe_w3L14T3VTIPYGYyqpDquiV0")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '948178492,948178492').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002126482256').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'gauravs1v')
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','gauravs1v') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','gps1w # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','gauravs1v') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','LayDeveloperr')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "gps1w) #[ without @ ]

# Url Shortner
URL_MODE = is_enabled((environ.get("URL_MODE","True")), False)
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'adrinolinks.com') #Always use website url from api section 
...
DOWNLOAD_TEXT_URL = "https://t.me/gauravs1v"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/gauravs1v"
